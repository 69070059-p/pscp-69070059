...
```text
นำค่าอาหารทั้งหมดมาคิดค่าบริการ แล้วดูว่าค่าบริการต่ำกว่า 50 บาทหรือสูงกว่า 1000 บาทมั้ย ถ้าต่ำกว่า 50 ให้ใช้ค่าบริการเป็น 50 บาท และถ้าค่าบริการสูงกว่า 1000 ให้ใช้ค่าบริการเป็น 1000 บาท จากนั้นนำค่าบริการที่ควรจะเป็นมารวมกับค่าอาหารทั้งหมด แล้วนำค่าที่รวมมาคิด vat แล้วใส่ทศนิยมเป็นสองตำแหน่ง
```
...
```text
step1: รับค่าตัวเลขn
step2: ตรวจสอบว่า (n*10)/100 แล้ว>=50 หรือ <=1000
step3: ถ้า<50 ใช้ (((50 + n )* 7)/100)+50+n 
step4: ถ้า>1000 ใช้ (((1000 +n)*7)/100)+50+n 
step5: ถ้าอยู่ตั้งแต่ 50 ถึง 1000 ให้ใช้ค่าตามจริงแล้วบวก n จากนั้น (*7)/100 แล้ว+ค่าตามจริง +n
step6: print ตามที่ต้องการตามด้วย:.2f
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก มีการใส่ if elif เพื่อสามารถ print ตามที่ต้องการได้
```
...
```text
เพราะ*10/100 ค่าออกมาจะน้อยกว่า 50
```
...
```text
เพราะ*10/100 ค่าออกมาจะมากกว่า 1000
```
...
```text
เพราะ*10/100 ค่าออกมาจะอยู่ตั้งแต่ 50 - 1000
```
