...
```text
โจทย์ให้นับจำนวนสระในข้อความ

Input:
โปรแกรมรับข้อความมาหนึ่งข้อความ

Output:
โปรแกรมควรพิมพ์ว่าสระที่มีคืออะไรและกี่ตัว

Constraints:
Output ต้องระวังสระที่ไม่มี ไม่ต้องแสดงออกมา
```
...
```text
Step 1: รับข้อความมาเป็นพิมพ์เล็ก
Step 2: ตรวจว่ามีสระในข้อความกี่ตัว
Step 3: ถ้ามีสระตัวไหนให้แสดงเป็นตัวสระ : จำนวน
Step 4: ถ้าไม่มีไม่ต้องแสดง
```
...
```text
เหมือนแผนแรก มีการใช้ for i in range
```
