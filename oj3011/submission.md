...
```text
โจทย์ใให้ผสมสีจากแม่สีเท่านั้น

Input:
โปรแกรมรับชื่อสีมาสองสี

Output:
แสดงสีที่ผสม หรือ  error

Constraints:
Input เป็นชื่อสีในแม่สี ควรพิจารณา สีอื่นหรือคำอะไรสักอย่างด้วย เพราะกันกรณี error
```
...
```text
step1: รับชื่อสีมาสองบรรทัด
step2: เขียน if elif ว่าถ้านำสีที่หนึ่งมาบวกกับสีที่สองให้ print เป็นสีที่ผสมออกมาที่ควรจะเป็น
step3: เขียนเงื่อนไขให้ครบทุกแม่สี
step4: เขียน else ให้ print error กรณีที่ใส่นอกเหนือจากแม่สี
```
...
```text
วิธัสุดท้ายเหมือนกับแผนแรก แต่จะเพิ่ม list เข้ามาเพื่อป้องกันการพิมพ์นอกเหนือชื่อแม่สี
```
...
```text
สีเดียวกันผสมกัน ควรจะเป็นสีเดิม
```
...
```text
ให้เทสเคสอีกอันทำให้แก้กรณีสีเหมือนกันได้
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียน code ทดสอบ ส่ง OJ เอง
```
