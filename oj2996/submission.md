...
```text
โจทย์ให้สลับตัวอักษรจากตัวหลังสุดมาเป็นตัวแรกแล้วก็ผลัดๆกันไปและเป็นตัวเล็ก

Input:
โปรแกรมรับข้อความภาษาอังกฤษ

Output:
โปรแกรมสลับตัวอักษรแล้วเป็นตัวพิมพ์เล็กหมด
...
```text
Step 1: รับตัวอักษรภาษาอังกฤษ
Step 2: พิมพ์กลับตัวอักษรโดยใช้ [::-1] กับ .lower()
Step 3: print ข้อความที่กลับแล้วเป็นตัวเล็กแล้ว
```
...
```text
เพราะทุกตัวเป็นตัวพิมพ์ใหญ่ แต่ควรเป็นพิมพ์เล็กหมด
```
